        ...
        <Container textCenter>
          <Repeat large>
            <Content center>
              ...
              <p>
                Välkommen till Viruskoll.se! Snart kommer du få information om
                hur du når företagets sida, samt den första frågan skickad till
                din e-postadress. Sedan kommer samma fråga dyka upp dagligen.
                Ditt svar bidrar till ett bättre underlag för Viruskoll.se.
              </p>
            </Content>
          </Repeat>
          <Repeat large>
